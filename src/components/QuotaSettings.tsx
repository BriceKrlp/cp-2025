        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div className="p-4 bg-blue-50 rounded-lg">
              <div className="text-2xl font-bold text-blue-600">{quota.vacation}</div>
              <div className="text-sm text-gray-600">Jours de CP</div>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              <div className="text-2xl font-bold text-green-600">{quota.rtt}</div>
              <div className="text-sm text-gray-600">Jours de RTT</div>
            </div>
            <div className="p-4 bg-purple-50 rounded-lg">
              <div className="text-2xl font-bold text-purple-600">{quota.previousYear}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              min="0"
              max="25"
              value={tempQuota.previousYear}
              onChange={(e) => setTempQuota(prev => ({
                ...prev,
                previousYear: parseInt(e.target.value) || 0
              }))}
            />
          </div>
        </div>
